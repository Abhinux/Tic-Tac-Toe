    ...
    def Win(self):
        ...
        if a["text"]==b["text"]==c["text"]==self.Move:
            ...
            if self.Move=="O":
                ...
                messagebox.showinfo("Super OX","O Won")
            elif self.Move=="X":
                w2+=1
                win=str(w2)
                W2["text"]=win
                W2.config(state="active")
                messagebox.showinfo("Super OX","X won")
...
def Change(b):
    ...
    if b["text"]==" ":
        ...
        Rings=Conditions("O")
        Cross=Conditions("X")
        z1,y1,x1,w11,v1,u1,t1,s1,r1=Rings.win1(),Rings.win2(),Rings.win3(),Rings.win4(),Rings.win5(),Rings.win6(),Rings.win7(),Rings.win8(),Rings.win9()
        z2,y2,x2,w12,v2,u2,t2,s2,r2=Cross.win1(),Cross.win2(),Cross.win3(),Cross.win4(),Cross.win5(),Cross.win6(),Cross.win7(),Cross.win8(),Cross.win9()
...
O=Button(root1,bg="white",text="O",bd=2,height=2,width=5)
X=Button(root1,bg="black",fg="white",bd=2,text="X",height=2,width=5)
W1=Button(root1,text=w1,bg="white",bd=2,height=2,width=5,activebackground="blue")
W2=Button(root1,text=w2,bg="white",bd=2,height=2,width=5,activebackground="blue")
